...
const BulkUpload = (props: any) => {
    ...
    const onFileSubmit = async () => {
        if (file) {
            ...
            try {
                const response = await orderApis.createBulkProduct(formData);
        ...
        <div className="p-8 mx-auto">
           ...
           <Button className='' color={'gray'} onClick={()=>props.setBulkUpload(false)}>
            ...
            <Label
                ...
                className="flex h-64 my-8 w-full object-contain cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                onDragOver={(e) => {
                    e.preventDefault();
